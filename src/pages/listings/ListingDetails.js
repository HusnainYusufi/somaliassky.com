...
// class ListingDetails extends Component {
    ...
    useEffect(() => {
      ...
      const getSingleListing = () => {
        // setLoading(true)
        fetch(`${url}/listing/getSpecificListing`, {
          method: "POST",
          headers: {
    ...
    // render() {
        return (
            <main className="listing-details">
                ...
                {/* Breadcrumb */}
                <ListingDetailsBreadcrumb title={SingleDetails?.title} />

                <ModalVideo channel='youtube' isOpen={isOpen} videoId={sectiondata.listingDetails.videoid} onClose={() => setIsOpen(false)} />
