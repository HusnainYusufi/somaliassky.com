...
export default function BannerOneSearchInput({ City }) {
  const [AllSearchListing, setAllSearchListing] = useState([]);
  const [AllSugessions, setAllSugessions] = useState([]);
  ...
  const SearchListing = (e) => {
    ...
    const myObject = {
      ...
      title: LookingFor.lookingFor,
      category: LookingFor.category,
    };
    const objectString = JSON.stringify(myObject);
    navigate.push(`/list-right-sidebar-list?data=${objectString}`);
  };
  const getDropDownData = (e, name) => {
    let obj = LookingFor;
    obj[name] = e.value;
    console.log(obj);
    setLookingFor(obj);
    ...
    <>
      <div className="main-search-input">
        ...
        <div className="main-search-input-item location">
          <Select
            name="country"
            onChange={(e) => getDropDownData(e, "location")}
        ...
        <div className="main-search-input-item category">
          <Select
            onChange={(e) => getDropDownData(e, "category")}
            name="category"
