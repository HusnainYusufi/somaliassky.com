...
export default function CtaOne() {
  ...
  const marginLeft =
    i18n.dir() === "rtl" ? "10px !important" : "10px !important";
  return (
    <>
        ...
        <div className="row">
          ...
          <div className="col-lg-6 ml-auto">
            <div className="mobile-app-content">
              <SectionsHeading
                title={sectiondata.calltoactions.cta2.title}
                titleClass="mb-3"
                desc={sectiondata.calltoactions.cta2.content}
                descClass="font-size-17 mb-4"
              />
              <ul className="info-list contact-links">
                {sectiondata.calltoactions.cta2.featurelists.map(
                  (item, index) => {
                    return (
                      <li
