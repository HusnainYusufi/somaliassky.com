...
const GeneralMap = compose(
    withProps({
        googleMapURL: "https://maps.googleapis.com/maps/api/js?key=AIzaSyCvyBRaARkJ7h9nNDFxWYuXXvAjBzpP0To&libraries",
    ...
    >
        <Marker
            ...
            position={{
                lat: 2.0469, // latitude to position the marker
                lng: 45.3182 // longitude to position the marker
            }}
        />
