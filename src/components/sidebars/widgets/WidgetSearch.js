...
function WidgetSearch({
  ...
  const getFormFieldData = (name, value, index) => {
    let obj = FormFields;
    obj[index]["name"] = name;
    obj[index]["value"] = value;
    console.log(obj);
    setFormFieldsSelected(obj);
  };
            ...
            return item.component === "dropdown" ? (
              <div className="mb-2">
                <div className="input-box">
                  {/* <label className="label-text">{t(item.fieldName)}</label> */}
                  <div className="form-group mb-0">
                    <Select
                      placeholder={t(item.fieldName)}
                      options={item.options}
                      onChange={(e) =>
                        getFormFieldData(item.fieldName, e.value, index)
                      }
                    />
                  </div>
                </div>
