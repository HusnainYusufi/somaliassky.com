    ...
    <>
      <div className="billing-form-item">
        <div className="billing-title-wrap">
          <h3 className="widget-title pb-0">{t(contactinfo.title)}</h3>
        ...
        <div className="billing-title-wrap pt-0">
          <h3 className="widget-title pb-0">{t("Working Hours")}</h3>
          <div className="title-shape margin-top-10px"></div>
        </div>
        <div className="billing-content">
          <ul className="list-items">
            <li className="d-flex align-items-center justify-content-between color-text-2">
              ...
              <strong className="font-weight-medium color-text-3">
                {t(contactinfo.opendaytime)}
              </strong>
            </li>
            <li className="d-flex align-items-center justify-content-between color-text-2">
              <strong className="font-weight-medium">
                {t(contactinfo.closeday)}
              </strong>
              <strong className="color-text">{t("Closed")}</strong>
            </li>
          </ul>
        </div>
      </div>
